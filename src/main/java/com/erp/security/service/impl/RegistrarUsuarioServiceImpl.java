...
import com.erp.security.repository.RegistrarUsuarioRepository;
import com.erp.security.repository.ResetarSenhaTokenRepository;
...
public class RegistrarUsuarioServiceImpl implements RegistrarUsuarioService {
	...
	private boolean emailExiste(String email) {
		return ( usuarioRepository.findUsuarioByEmail(email).isPresent() ? false : true);
	}

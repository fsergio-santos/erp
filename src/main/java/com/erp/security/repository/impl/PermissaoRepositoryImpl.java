...
import com.erp.security.model.Permissao_;
...
public class PermissaoRepositoryImpl implements PermissaoRepositoryQuery {
	...
	public Optional<Permissao> buscarPermissaoPeloNome(String nome) {
		TypedQuery<Permissao> query = entityManager.createQuery("SELECT p FROM Permissao p WHERE p.nome  = :nome", Permissao.class);

...
public class MessageErrors implements Serializable {
	...
	private static final long serialVersionUID = 2262511076931652692L;
    ...
    public static class Builder {
        ...
        private MessageErrors erro;

        Builder() {
            this.erro = new MessageErrors();
        }

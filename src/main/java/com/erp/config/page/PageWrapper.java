...
public class PageWrapper<T> {
	...
	public PageWrapper(Page<T> page, int pageSize, HttpServletRequest httpServletRequest ) {
		this.page = page;
	...
	public String urlParaPagina(int size, int pagina) {
		String url = uriBuilder.replaceQueryParam("page", pagina, "size", size).build(true).encode().toUriString();
		return url;
	}			
